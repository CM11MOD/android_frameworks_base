...
public class NetworkController extends BroadcastReceiver implements DemoMode {
    ...
    private String mCustomCarrierLabel = "";
    ...
    private final void updateTelephonySignalStrength() {
        if (!hasService() &&
            ...
            mQSPhoneSignalIconId = (mHideSignal ? 0 : R.drawable.ic_qs_signal_no_signal);
            ...
            if ((mSignalStrength == null) || (mServiceState == null)) {
                ...
                mQSPhoneSignalIconId = (mHideSignal ? 0 : R.drawable.ic_qs_signal_no_signal);
                mDataSignalIconId = (mHideSignal ? 0 : R.drawable.stat_sys_signal_null);
                mContentDescriptionPhoneSignal = (mHideSignal ? 0 : mContext.getString(
                ...
                mQSPhoneSignalIconId = (mHideSignal ? 0 :
